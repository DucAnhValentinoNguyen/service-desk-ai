...
type PlatformOverview = {
  available: boolean;
  run_id?: string;
  summary?: { gold?: Record<string, number>; training?: { model_name?: string }; evaluation?: { risk_rate?: number } };
...
export default function Home() {
  ...
  async function refresh() {
    ...
    try {
      ...
      setRequests(nextRequests); setApprovals(nextApprovals); setPlatform(nextPlatform);
